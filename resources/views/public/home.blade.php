...
<div class="container-fluid accueil text-white">
  <div class="row">
    <h1 class="col-xs-12 col-md-10 offset-md-1 Rockit textShad">Le Rock'n <span class="redCustom">Burger</span></h1>
    <div class="col-7 offset-5 text-center pt-2">
